...
def cv(training_data, validation_data, y_name, u_name, order, method=None, settings={}, bounds=(0,100)):

    def fun(l):
        settings["lambda"] = 10**l
        mod = sysid(training_data, y_name, u_name, order, method=method, settings=settings)
