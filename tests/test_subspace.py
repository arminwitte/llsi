...
def test_n4sid_mimo(data_mimo_deterministic, ss_mod):
    ...
    np.testing.assert_allclose(
        mod.info["Hankel singular values"],
        [6.40829670e+00, 3.94039974e-04, 2.47748028e-08, 1.01130860e-08,
 9.63664129e-09, 7.82223423e-09, 7.34439653e-09, 7.30785370e-09,
 6.41191499e-09, 5.96869347e-09, 5.92269632e-09 ,5.38759994e-09,
 5.29767778e-09, 5.02836434e-09 ,4.37323782e-09, 4.03590185e-09,
 3.79029097e-09, 3.32988710e-09 ,2.74121403e-09, 2.40889178e-09,],
        rtol=1e-6,
        atol=1e-6,
    )
    np.testing.assert_allclose(
