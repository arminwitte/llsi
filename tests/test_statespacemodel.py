...
def model_mimo():
    return StateSpaceModel(
        A=[[ 0.81867495, -0.00333706],
 [-0.007094,    0.86617556]],
        B=[[-0.00337626, -0.07836226],
 [ 0.04858446, -0.01158329]],
        C=[[-0.37475845,  2.53533251],
 [-4.17568704, -0.29021108]],
        D=[[ 6.66661097e-02, -4.52249005e-07],
 [-6.33970438e-07,  1.81817685e-01]],
        Ts=1,
        input_names=["input"],
        output_names=["output"],
    )
...
def test_frequency_mimo(model_mimo):
  ...
  [ 3.36301580e-06-1.15636248e-07j,  1.99994478e+00-9.99971819e-03j]],

 [[ 9.99925564e-01-8.85347893e-03j, -6.23798087e-06+6.52640751e-08j],
  [ 3.36224771e-06-1.46254530e-07j,  1.99991479e+00-1.26480067e-02j]],

 [[ 9.99878547e-01-1.11978433e-02j, -6.23759099e-06+8.25448998e-08j],
  [ 3.36101903e-06-1.84973444e-07j , 1.99986681e+00-1.59975147e-02j]],
        ],
    )
